    ...
    public partial class LoginBox : UserControl
    {
        ...
        private void ChangeColors(bool ChangeColors)
        {
            if (ChangeColors)
            {
                ...
                p_top.BackColor = ActivatedBackColor;
                p_buttom.BackColor = ActivatedBackColor;
            ...
            else
            {
                ...
                p_top.BackColor = Control_BackColor;
                p_buttom.BackColor = Control_BackColor;
        ...
        private void SearchTextBox_Load(object sender, EventArgs e)
        {
            ...
            p_top.BackColor = this.Control_BackColor;
            p_buttom.BackColor = this.Control_BackColor;
        ...
        {
            int Height = (this.Height - 4) - panel4.Height;
            p_top.Height = Height/2;
            p_buttom.Height = Height / 2;
            logo_box.Height = logo_box.Width;
        }
    }
}
